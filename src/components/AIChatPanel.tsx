...
import { Send, Sparkles, Bot, User, Loader2, Trash2, Copy, Check, ChevronDown, Eye, EyeOff, CheckCircle2, Camera, FileText, Brain, Zap, Wand2, Globe, ShoppingCart, Gamepad2, LayoutDashboard } from "lucide-react";
